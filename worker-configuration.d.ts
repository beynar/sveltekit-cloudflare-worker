/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d725072da5f57b1bd5ac71fccaedb4e9)
// Runtime types generated with workerd@1.20260131.0 2025-01-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.svelte-kit/cloudflare/_worker");
		durableNamespaces: "MyDurableObject" | "ChatRoom" | "WorkflowOrchestrator";
	}
	interface Env {
		RATELIMIT_CHAT: RateLimit;
		ASSETS: Fetcher;
		MY_DO: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").MyDurableObject>;
		CHAT_ROOM: DurableObjectNamespace<import("./.svelte-kit/cloudflare/_worker").ChatRoom>;
		WORKFLOW_DO: DurableObjectNamespace /* WorkflowOrchestrator */;
		PROGRESS_WORKFLOW: Workflow /* ProgressWorkflow */;
	}
}
